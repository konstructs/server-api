...
/**
 * This class represents the user's primary interaction (left mouse button). It is received by a plugin using
 *  {@link InteractPrimaryFilter} message sent from the server.
 */
public class InteractPrimary {
    ...
    public boolean equals(Object o) {
        ...
        InteractPrimary that = (InteractPrimary) o;
